          ...
          <div className="flex-1 flex justify-center">
            <div className="relative">
              ...
              <div className="relative transform-gpu" style={{ transform: 'perspective(1000px) rotateY(-15deg) rotateX(5deg)' }}>
                ...
                <div className="w-80 h-[650px] bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 rounded-[3.5rem] p-3 shadow-2xl relative">
                  ...
                  <div className="w-full h-full bg-white rounded-[3rem] overflow-hidden relative">
                    {/* Status Bar */}
                    <div className="bg-[#081c2b] h-12 w-full flex items-center justify-between px-8 text-white text-sm font-medium">
                      <span>9:41</span>
                    ...
                    <div className="p-6 space-y-6 h-full bg-gradient-to-br from-gray-50 to-white">
                      ...
                      <div className="text-center pt-4">
                        <h3 className="text-2xl font-bold text-[#081c2b] mb-2">Bom dia, Sara!</h3>
                        <p className="text-gray-600">Como se sente hoje?</p>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-[#00a9e0]/20 rounded-xl p-4 text-center border border-[#00a9e0]/30">
                          <div className="w-10 h-10 bg-[#00a9e0] rounded-full mx-auto mb-3 flex items-center justify-center">
                            <span className="text-white text-lg">📊</span>
                          </div>
                          <p className="text-sm text-gray-700 font-medium">Acompanhar Humor</p>
                        </div>
                        <div className="bg-[#CCE4F7]/20 rounded-xl p-4 text-center border border-[#CCE4F7]/30">
                          <div className="w-10 h-10 bg-[#00529B] rounded-full mx-auto mb-3 flex items-center justify-center">
                            <span className="text-white text-lg">🤝</span>
                          </div>
                          <p className="text-sm text-gray-700 font-medium">Obter Apoio</p>
                        </div>
                      </div>
                      
                      {/* AI Suggestion */}
                      <div className="bg-gradient-to-r from-[#081c2b] to-[#00529B] rounded-xl p-6 text-white border border-[#00a9e0]/30">
                        <h4 className="font-bold mb-3 flex items-center">
                          <span className="mr-2">💡</span>
                          Sugestão da IA
                        </h4>
                        <p className="text-sm opacity-90 leading-relaxed">Experimente um exercício de respiração de 5 minutos antes da próxima verificação da glicose para ajudar a reduzir a ansiedade.</p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="absolute -bottom-12 -left-16 transform -rotate-6">
                <div className="w-56 h-40 bg-white rounded-xl shadow-lg border border-[#00a9e0]/30 p-4">
                  <div className="h-full bg-gradient-to-br from-[#CCE4F7]/10 to-[#00a9e0]/10 rounded-lg flex flex-col justify-center items-center">
                    <div className="text-3xl mb-2">🧘‍♀️</div>
                    <h4 className="font-bold text-[#081c2b] text-sm">Ferramentas de Adaptação</h4>
                    <p className="text-xs text-gray-600 text-center mt-1">Estratégias personalizadas</p>
                  </div>
                </div>
              </div>
              
              {/* Floating Elements */}
              <div className="absolute -top-8 -right-8 w-16 h-16 bg-[#00a9e0] rounded-full opacity-20 animate-bounce"></div>
              <div className="absolute -bottom-8 -left-8 w-12 h-12 bg-[#CCE4F7] rounded-full opacity-20 animate-bounce delay-1000"></div>
            </div>
          </div>
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4 text-white">
                <div className="w-3 h-3 bg-[#00a9e0] rounded-full"></div>
                <span>Reconhecimento inteligente de padrões de humor</span>
              </div>
              <div className="flex items-center space-x-4 text-white">
                <div className="w-3 h-3 bg-[#CCE4F7] rounded-full"></div>
                <span>Recomendações personalizadas de adaptação</span>
              </div>
              <div className="flex items-center space-x-4 text-white">
                <div className="w-3 h-3 bg-[#00529B] rounded-full"></div>
                <span>Integração perfeita da gestão da diabetes</span>
              </div>
            </div>
