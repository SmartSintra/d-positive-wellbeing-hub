...
const CallToAction = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-[#081c2b] via-[#00529B] to-[#081c2b] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 mt-8 text-sm">
            Vagas limitadas disponíveis • Sem compromisso necessário • Gratuito durante o beta
          </p>
        </div>
      </div>
    </section>
