          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-[#B86DFE] rounded-full flex items-center justify-center">
                    <span className="text-white font-bold">💬</span>
                  </div>
                  <div>
                    <p className="font-semibold text-[#18143C]">Join Our Community</p>
                    <p className="text-gray-600">Connect with other T1D individuals</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <Input 
                    ...
                    className="border-gray-300 focus:border-[#3ED3FE] focus:ring-[#3ED3FE]"
                  />
                </div>
                ...
                <Button 
                  type="submit"
                  className="w-full bg-[#B86DFE] hover:bg-[#a05ce6] text-white py-3 text-lg font-semibold rounded-lg transition-all duration-300 hover:scale-105"
                >
                  Send Message
                </Button>
              </form>
