      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Button 
              variant="outline" 
              className="border-[#3ED3FE] text-[#3ED3FE] hover:bg-[#3ED3FE] hover:text-white"
            >
              Join Beta
            </Button>
            <Button 
              variant="outline" 
              className="border-[#B86DFE] text-[#B86DFE] hover:bg-[#B86DFE] hover:text-white"
            >
              Subscribe for More
            </Button>
            <Button 
              variant="ghost" 
              className="text-gray-700 hover:text-[#18143C] flex items-center space-x-1"
            >
